...
class Fragment_Intro_3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment__intro_3, container, false)

        //Cuando pulsen siguiente
        val nextBtn: Button = view.findViewById(R.id.btnNext)
        nextBtn.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_fragment_Intro_3_to_fragment_Intro_4)
        }

        //Cuando pulsen regresar
        val backBtn: Button = view.findViewById(R.id.btnBack)
        backBtn.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_fragment_Intro_3_to_fragment_Intro_2)
